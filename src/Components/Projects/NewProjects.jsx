  ...
  const projects = [
    {
      ...
      project_desc:
        'Crowdfunding DAPP, where users can support the project with voting mechanism to withdraw funds from campaigns.',
      deploy_link: 'http://qrowdy.vercel.app/',
      repo_link: 'https://github.com/shubham-rathod1/Qrowdy',
      tech_stack: [
        <SiNextdotjs />,
        <SiSolidity />,
        <FaJs />,
